...
Define the orchestration metrics attached to LangSmith runs and feedback
scores - token/cost/context-window metadata per model step, tool data-hit
scoring, and the documented evaluator/operator views for reading them.
